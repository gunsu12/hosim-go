...
type Patient struct {
	...
	NIK                 string                    `gorm:"uniqueIndex;size:16" json:"nik"`
	IHSPatientID        string                    `gorm:"index;size:50" json:"ihs_patient_id,omitempty"`
	...
	Gender              string                    `gorm:"size:6" json:"gender"`
...
type PatientDrugHistory struct {
	...
	CronicalyUse bool           `gorm:"default:false" json:"cronicaly_use"`
